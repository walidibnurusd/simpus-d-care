...
@section('breadcrumb-items')
    ...
    <li class="breadcrumb-item active">Layak Hamil</li>
@endsection
                                    ...
                                    @foreach ($layakHamil as $item)
                                        <tr>
                                            ...
                                            <td>
                                                <ul class="action">
                                                    <li class="edit"> <a
                                                            href="{{ route('layak_hamil.edit', $item->id) }}"><i
                                                    ...
                                                    <li class="delete">
                                                        ...
                                                        <form action="{{ route('layak_hamil.delete', $item->id) }}"
