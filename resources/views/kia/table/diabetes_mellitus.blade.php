                                    ...
                                    @foreach ($diabetesMellitus as $item)
                                        <tr>
                                            ...
                                            <td>
                                                <ul class="action">
                                                    <li class="edit">
                                                        @if ($routeName === 'diabetes.mellitus.admin')
                                                            <a href="{{ route('diabetes.mellitus.edit', $item->id) }}"><i
                                                                    class="icon-pencil-alt"></i></a>
                                                        @else
                                                            <a href="{{ route('diabetes.mellitus.mtbs.edit', $item->id) }}"><i
                                                                    class="icon-pencil-alt"></i></a>
                                                        @endif
                                                    </li>
                                                    <li class="delete">
                                                        ...
                                                        <form action="{{ route('diabetes.mellitus.delete', $item->id) }}"
