...
@section('breadcrumb-items')
    ...
    <li class="breadcrumb-item active">Diabetes Mellitus</li>
@endsection
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="display" id="basic-1">
                                ...
                                <tbody>
                                    @foreach ($diabetesMellitus as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <ul class="action">
                                                <li class="edit"> <a href="{{ route('diabetes.mellitus.edit', $item->id) }}"><i class="icon-pencil-alt"></i></a>
                                                </li>
                                                <li class="delete">
                                                    ...
                                                    <form action="{{ route('diabetes.mellitus.delete', $item->id) }}" method="POST" id="delete-form-{{ $item->id }}" style="display:none;">
                                                        @csrf
                                                        @method('DELETE')
                                                    </form>
                                                </li>
