                            ...
                            <table class="display" id="basic-1">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <ul class="action">
                                                <li class="edit"> <a href="{{ route('anemia.edit', $item->id) }}"><i class="icon-pencil-alt"></i></a>
                                                </li>
                                                <li class="delete">
                                                    ...
                                                    <form action="{{ route('anemia.delete', $item->id) }}" method="POST" id="delete-form-{{ $item->id }}" style="display:none;">
                                                        @csrf
                                                        @method('DELETE')
                                                    </form>
                                                </li>
