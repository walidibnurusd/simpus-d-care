    ...
    <nav class="navbar navbar-main navbar-expand-lg fixed-top px-4 shadow-none bg-primary" id="navbarBlur" >
        <div class="container-fluid py-1 px-3">
            ...
            <div class="d-flex align-items-center">
                <a href="#" class="btn btn-outline-primary btn-sm font-weight-bold collapse-btn" id="sidenavCollapseButton" style="width: 50px; height: 50px; padding: 0; margin-right: 15px; display: flex; align-items: center; justify-content: center;">
                ...
                <a class="navbar-brand d-flex align-items-center" href="#">
                    ...
                    <span class="text-white ms-2">PUSKESMAS MAKASSAR</span>
                </a>
            </div>
