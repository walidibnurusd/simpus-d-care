...
@section('title', 'Penerimaan Obat Apotek')
...
@section('breadcrumb-title')
    <h3>Penerimaan Obat Apotek</h3>
@endsection

@section('breadcrumb-items')
    <li class="breadcrumb-item">{{ Auth::user()->name }}</li>
    <li class="breadcrumb-item active">Penerimaan Obat Apotek</li>
@endsection
        ...
        <div class="row">
            <div class="col-12 mb-4">
                <div class="button-container">
                    ...
                    <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#terimaObatModal">
                        Tambah
                ...
                @include('component.modal-terima-obat')
