    ...
    <div class="table-container">
        <table border="1">
            ...
            <tbody>
                ...
                <tr>
                    <td>5</td>
                    <td colspan="2" class="left-align">Jumlah penderita penyakit tidak menular dirujuk ke fasilitas
                        pelayanan kesehatan rujukan tingkat lanjut</td>
                    <td></td>
                    <td></td>
                </tr>
                <tr>
        ...
        <table border="1" style="margin-top:10px">
            ...
            <tbody>
                ...
                <tr>
                    <td>2</td>
                    <td colspan="2" class="left-align">Jumlah ibu hamil, melahirkan, nifas dengan gangguan kesehatan
                        dirawat inap</td>
                    <td></td>
                    <td></td>
                </tr>
                ...
                <tr>
                    <td>6</td>
                    <td colspan="2" class="left-align">Jumlah penderita yang keluar sembuh dari rawat inap puskesmas
                    </td>
                    <td></td>
                    <td></td>
                </tr>
        ...
        <table border="1" style="margin-top:10px">
            ...
            <tbody>
                ...
                <tr>
                    <td>8</td>
                    <td colspan="2" class="left-align">Jumlah SD/MI dilaksanakan pemeriksaan kesehatan gigi dan
                        mulut</td>
                    <td></td>
                    <td></td>
                </tr>
                ...
                <tr>
                    <td>10</td>
                    <td colspan="2" class="left-align">Jumlah murid SD/MI yang mendapat perawatan kesehatan gigi
                    </td>
                    <td></td>
                    <td></td>
                </tr>
                ...
                <tr>
                    <td>12</td>
                    <td colspan="2" class="left-align">Jumlah TK/PAUD yang dilakukan pemeriksaan kesehatan gigi dan
                        mulut</td>
                    <td></td>
                    <td></td>
                </tr>
