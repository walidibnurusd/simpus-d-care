...
<body>
    ...
    <div class="header" style="text-align: left">
        <div class="subtitle">
            <p>
                <span class="fw-bold">Puskesmas:</span>
                <span class="badge bg-primary">Tamangapa</span>
            </p>
            <p>
                <span class="fw-bold">Kabupaten/Kota:</span>
                <span class="badge bg-success">Makassar</span>
            </p>
            <p>
                <span class="fw-bold">Provinsi:</span>
                <span class="badge bg-info">Sulawesi Selatan</span>
            </p>
            <p>
