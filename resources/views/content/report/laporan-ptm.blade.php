...
<head>
    ...
    <title>JUMLAH KASUS DAN KEMATIAN PENYAKIT TIDAK MENULAR MENURUT JENIS KELAMIN DAN UMUR</title>
    <!-- Bootstrap CSS -->
...
<body>
    ...
    <table class="table table-bordered">
        ...
        <tbody>
            ...
            <tr>
                <td>11</td>
                <td> Kecelakaan Lalulintas Jalan</td>
                <td>2</td>
                <td>3</td>
                <td>3</td>
                <td>3</td>
            ...
            <tr>
                <td>15</td>
                <td> Tumor Pada Bibir, Rongga Mulut</td>
                <td>2</td>
                <td>3</td>
                <td>3</td>
                <td>3</td>
            ...
            <tr>
                <td>16</td>
                <td>Tumor Genitalia Externa Perempuan</td>
                <td>2</td>
                <td>3</td>
                <td>3</td>
                <td>3</td>
            ...
            <tr>
                <td>18</td>
                <td> Tumor Genitalia Interna Perempuan (Kecuali Serviks)</td>
                <td>2</td>
                <td>3</td>
                <td>3</td>
                <td>3</td>
    ...
    <table style="margin-top:10px">
        <tr style="border: none;">
            <th style="text-align: left; border: none;width: 100%;">Jumlah kasus lama (Kunjungan ke-2 atau lebih)</th>
        </tr>
    </table>
    <table class="table table-bordered">
        <thead>
    ...
    <table style="margin-top:10px">
        <tr style="border: none;">
            <th style="text-align: left; border: none;width: 100%;">Jumlah kematian</th>
        </tr>
    </table>
    <table class="table table-bordered">
        <thead>
