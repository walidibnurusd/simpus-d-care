<!-- Modal Add Action -->
<div class="modal fade" style="z-index: 1050;" id="editActionObatModal{{ $action->id }}" tabindex="-1"
    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
                ...
                <form id="addActionObat" method="POST" class="px-3">
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-md-4" style="margin-bottom: 15px;">
                            ...
                            <input type="text" class="form-control" id="alergi{{ $action->id }}" name="alergi[]"
                    ...
                    <div class="row mt-3">
                        <div class="col-md-4" style="margin-bottom: 15px;">
                            ...
                            <input type="text" class="form-control" id="jumlah{{ $action->id }}" name="jumlah[]"
                                placeholder="Jumlah">
                        </div>

                        <div class="col-md-4" style="margin-bottom: 15px;">
                            <label for="stok{{ $action->id }}" style="color: rgb(19, 11, 241);">Stok</label>
                            <input type="text" class="form-control" id="stok{{ $action->id }}" name="stok[]"
                        ...
                        <div class="col-md-4" style="margin-bottom: 15px;">
                            <label for="gangguan_ginjal" style="color: rgb(19, 11, 241);">Gangguan Fungsi
                                Hati/Ginjal</label>
                            <input type="text" class="form-control" id="gangguan_ginjal{{ $action->id }}"
                    ...
                    <div class="row mt-3">
                        <div class="col-md-4" style="margin-bottom: 15px;">
                            ...
                            <input type="text" class="form-control" id="dosis{{ $action->id }}" name="dosis[]"
                                placeholder="Dosis">
                        </div>

                        <div class="col-md-4" style="margin-bottom: 15px;">
                            <label for="hamil" style="color: rgb(19, 11, 241);">Hamil ?</label>
                            <input type="text" class="form-control" id="hamil{{ $action->id }}" name="hamil[]"
                    ...
                    <button type="button" class="btn btn-success" id="addMedicationBtn{{ $action->id }}">Tambah
                        Obat</button>
                        ...
                        <tbody id="medicationTableBody{{ $action->id }}">
                            @forelse ($action->actionObats as $item)
                                @php
                                    ...
                                    $shapeName = $shapeMapping[$item->shape] ?? 'Unknown';
                                @endphp
                                <tr>
                                    ...
                                    <td><button class="btn btn-danger btn-sm" onclick="removeRow(this)">Hapus</button>
                                    </td>
                                </tr>
                            @empty
                                <tr>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" id="saveToPreviousModalBtn{{ $action->id }}"
...
<script>
    ...
    `;
        ...
        document.getElementById("saveToPreviousModalBtn{{ $action->id }}").addEventListener("click",
            function() {
                ...
                document.getElementById("medicationsData{{ $action->id }}").value = JSON.stringify(
                    medicationsData);
