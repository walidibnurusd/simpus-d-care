...
@section('content')
    ...
    <form action="{{ isset($obesitas) ? route('obesitas.mtbs.update', $obesitas->id) : route('obesitas.mtbs.store') }}" method="POST">
        @csrf
        @if (isset($obesitas))
            @method('PUT')
        @endif
        ...
        <div class="col-md-12 mb-3">
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="hasil" 
                    value="{{ old('hasil', isset($obesitas) ? $obesitas->hasil : '') }}" 
                    placeholder="Masukkan" style=" display: inline-block;">
        ...
        <div class="text-right mt-4">
            ...
            <a href="{{ route('obesitas.mtbs.admin') }}" type="button" class="btn btn-secondary mr-2" style="font-size: 20px">Kembali</a>
        @else
