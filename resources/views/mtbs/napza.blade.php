...
@section('content')
        ...
        <div class="form-section">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="nama_pasien" 
                               ...
                               value="{{ old('nama_pasien', $napza->nama_pasien??'') }}">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <label>Klinik</label>
                        <input type="text" class="form-control" name="klinik" 
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="d-flex">
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan2[freq_tembakau_P2]" value="2"
                                    ...
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan2[freq_tembakau_P2]" value="3"
                                    ...
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan2[freq_tembakau_P2]" value="4"
                                    ...
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan2[freq_tembakau_P2]" value="6"
                                    ...
                                    <div class="form-check ml-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan2[freq_tembakau_P2]" value="0"
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="d-flex">
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan2[freq_alkohol_P2]" value="2"
                                            {{ isset($napza->pertanyaan2['freq_alkohol_P2']) && $napza->pertanyaan2['freq_alkohol_P2'] == '2' ? 'checked' : '' }}>
                                        <label class="form-check-label">Sekali atau dua kali</label>
                                    </div>
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan2[freq_alkohol_P2]" value="3"
                                            {{ isset($napza->pertanyaan2['freq_alkohol_P2']) && $napza->pertanyaan2['freq_alkohol_P2'] == '3' ? 'checked' : '' }}>
                                        <label class="form-check-label">Tiap bulan</label>
                                    </div>
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan2[freq_alkohol_P2]" value="4"
                                            {{ isset($napza->pertanyaan2['freq_alkohol_P2']) && $napza->pertanyaan2['freq_alkohol_P2'] == '4' ? 'checked' : '' }}>
                                        <label class="form-check-label">Tiap minggu</label>
                                    </div>
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan2[freq_alkohol_P2]" value="6"
                                            {{ isset($napza->pertanyaan2['freq_alkohol_P2']) && $napza->pertanyaan2['freq_alkohol_P2'] == '6' ? 'checked' : '' }}>
                                        <label class="form-check-label">Selalu atau hampir selalu</label>
                                    </div>
                                    <div class="form-check ml-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan2[freq_alkohol_P2]" value="0"
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="d-flex">
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan2[freq_kanabis_P2]" value="2"
                                            {{ isset($napza->pertanyaan2['freq_kanabis_P2']) && $napza->pertanyaan2['freq_kanabis_P2'] == '2' ? 'checked' : '' }}>
                                        <label class="form-check-label">Sekali atau dua kali</label>
                                    </div>
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan2[freq_kanabis_P2]" value="3"
                                            {{ isset($napza->pertanyaan2['freq_kanabis_P2']) && $napza->pertanyaan2['freq_kanabis_P2'] == '3' ? 'checked' : '' }}>
                                        <label class="form-check-label">Tiap bulan</label>
                                    </div>
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan2[freq_kanabis_P2]" value="4"
                                            {{ isset($napza->pertanyaan2['freq_kanabis_P2']) && $napza->pertanyaan2['freq_kanabis_P2'] == '4' ? 'checked' : '' }}>
                                        <label class="form-check-label">Tiap minggu</label>
                                    </div>
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan2[freq_kanabis_P2]" value="6"
                                            {{ isset($napza->pertanyaan2['freq_kanabis_P2']) && $napza->pertanyaan2['freq_kanabis_P2'] == '6' ? 'checked' : '' }}>
                                        <label class="form-check-label">Selalu atau hampir selalu</label>
                                    </div>
                                    <div class="form-check ml-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan2[freq_kanabis_P2]" value="0"
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="d-flex">
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan2[freq_kokain_P2]" value="2"
                                            {{ isset($napza->pertanyaan2['freq_kokain_P2']) && $napza->pertanyaan2['freq_kokain_P2'] == '2' ? 'checked' : '' }}>
                                        <label class="form-check-label">Sekali atau dua kali</label>
                                    </div>
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan2[freq_kokain_P2]" value="3"
                                            {{ isset($napza->pertanyaan2['freq_kokain_P2']) && $napza->pertanyaan2['freq_kokain_P2'] == '3' ? 'checked' : '' }}>
                                        <label class="form-check-label">Tiap bulan</label>
                                    </div>
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan2[freq_kokain_P2]" value="4"
                                            {{ isset($napza->pertanyaan2['freq_kokain_P2']) && $napza->pertanyaan2['freq_kokain_P2'] == '4' ? 'checked' : '' }}>
                                        <label class="form-check-label">Tiap minggu</label>
                                    </div>
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan2[freq_kokain_P2]" value="6"
                                            {{ isset($napza->pertanyaan2['freq_kokain_P2']) && $napza->pertanyaan2['freq_kokain_P2'] == '6' ? 'checked' : '' }}>
                                        <label class="form-check-label">Selalu atau hampir selalu</label>
                                    </div>
                                    <div class="form-check ml-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan2[freq_kokain_P2]" value="0"
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="d-flex">
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan2[freq_stimulan_P2]" value="2"
                                            {{ isset($napza->pertanyaan2['freq_stimulan_P2']) && $napza->pertanyaan2['freq_stimulan_P2'] == '2' ? 'checked' : '' }}>
                                        <label class="form-check-label">Sekali atau dua kali</label>
                                    </div>
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan2[freq_stimulan_P2]" value="3"
                                            {{ isset($napza->pertanyaan2['freq_stimulan_P2']) && $napza->pertanyaan2['freq_stimulan_P2'] == '3' ? 'checked' : '' }}>
                                        <label class="form-check-label">Tiap bulan</label>
                                    </div>
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan2[freq_stimulan_P2]" value="4"
                                            {{ isset($napza->pertanyaan2['freq_stimulan_P2']) && $napza->pertanyaan2['freq_stimulan_P2'] == '4' ? 'checked' : '' }}>
                                        <label class="form-check-label">Tiap minggu</label>
                                    </div>
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan2[freq_stimulan_P2]" value="6"
                                            {{ isset($napza->pertanyaan2['freq_stimulan_P2']) && $napza->pertanyaan2['freq_stimulan_P2'] == '6' ? 'checked' : '' }}>
                                        <label class="form-check-label">Selalu atau hampir selalu</label>
                                    </div>
                                    <div class="form-check ml-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan2[freq_stimulan_P2]" value="0"
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="d-flex">
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan2[freq_inhalansia_P2]" value="2"
                                            {{ isset($napza->pertanyaan2['freq_inhalansia_P2']) && $napza->pertanyaan2['freq_inhalansia_P2'] == '2' ? 'checked' : '' }}>
                                        <label class="form-check-label">Sekali atau dua kali</label>
                                    </div>
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan2[freq_inhalansia_P2]" value="3"
                                            {{ isset($napza->pertanyaan2['freq_inhalansia_P2']) && $napza->pertanyaan2['freq_inhalansia_P2'] == '3' ? 'checked' : '' }}>
                                        <label class="form-check-label">Tiap bulan</label>
                                    </div>
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan2[freq_inhalansia_P2]" value="4"
                                            {{ isset($napza->pertanyaan2['freq_inhalansia_P2']) && $napza->pertanyaan2['freq_inhalansia_P2'] == '4' ? 'checked' : '' }}>
                                        <label class="form-check-label">Tiap minggu</label>
                                    </div>
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan2[freq_inhalansia_P2]" value="6"
                                            {{ isset($napza->pertanyaan2['freq_inhalansia_P2']) && $napza->pertanyaan2['freq_inhalansia_P2'] == '6' ? 'checked' : '' }}>
                                        <label class="form-check-label">Selalu atau hampir selalu</label>
                                    </div>
                                    <div class="form-check ml-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan2[freq_inhalansia_P2]" value="0"
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="d-flex">
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan2[freq_sedativa_P2]" value="2"
                                            {{ isset($napza->pertanyaan2['freq_sedativa_P2']) && $napza->pertanyaan2['freq_sedativa_P2'] == '2' ? 'checked' : '' }}>
                                        <label class="form-check-label">Sekali atau dua kali</label>
                                    </div>
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan2[freq_sedativa_P2]" value="3"
                                            {{ isset($napza->pertanyaan2['freq_sedativa_P2']) && $napza->pertanyaan2['freq_sedativa_P2'] == '3' ? 'checked' : '' }}>
                                        <label class="form-check-label">Tiap bulan</label>
                                    </div>
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan2[freq_sedativa_P2]" value="4"
                                            {{ isset($napza->pertanyaan2['freq_sedativa_P2']) && $napza->pertanyaan2['freq_sedativa_P2'] == '4' ? 'checked' : '' }}>
                                        <label class="form-check-label">Tiap minggu</label>
                                    </div>
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan2[freq_sedativa_P2]" value="6"
                                            {{ isset($napza->pertanyaan2['freq_sedativa_P2']) && $napza->pertanyaan2['freq_sedativa_P2'] == '6' ? 'checked' : '' }}>
                                        <label class="form-check-label">Selalu atau hampir selalu</label>
                                    </div>
                                    <div class="form-check ml-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan2[freq_sedativa_P2]" value="0"
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="d-flex">
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan2[freq_halusinogen_P2]" value="2"
                                            {{ isset($napza->pertanyaan2['freq_halusinogen_P2']) && $napza->pertanyaan2['freq_halusinogen_P2'] == '2' ? 'checked' : '' }}>
                                        <label class="form-check-label">Sekali atau dua kali</label>
                                    </div>
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan2[freq_halusinogen_P2]" value="3"
                                            {{ isset($napza->pertanyaan2['freq_halusinogen_P2']) && $napza->pertanyaan2['freq_halusinogen_P2'] == '3' ? 'checked' : '' }}>
                                        <label class="form-check-label">Tiap bulan</label>
                                    </div>
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan2[freq_halusinogen_P2]" value="4"
                                            {{ isset($napza->pertanyaan2['freq_halusinogen_P2']) && $napza->pertanyaan2['freq_halusinogen_P2'] == '4' ? 'checked' : '' }}>
                                        <label class="form-check-label">Tiap minggu</label>
                                    </div>
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan2[freq_halusinogen_P2]" value="6"
                                            {{ isset($napza->pertanyaan2['freq_halusinogen_P2']) && $napza->pertanyaan2['freq_halusinogen_P2'] == '6' ? 'checked' : '' }}>
                                        <label class="form-check-label">Selalu atau hampir selalu</label>
                                    </div>
                                    <div class="form-check ml-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan2[freq_halusinogen_P2]" value="0"
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="d-flex">
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan2[freq_opioid_P2]" value="2"
                                            {{ isset($napza->pertanyaan2['freq_opioid_P2']) && $napza->pertanyaan2['freq_opioid_P2'] == '2' ? 'checked' : '' }}>
                                        <label class="form-check-label">Sekali atau dua kali</label>
                                    </div>
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan2[freq_opioid_P2]" value="3"
                                            {{ isset($napza->pertanyaan2['freq_opioid_P2']) && $napza->pertanyaan2['freq_opioid_P2'] == '3' ? 'checked' : '' }}>
                                        <label class="form-check-label">Tiap bulan</label>
                                    </div>
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan2[freq_opioid_P2]" value="4"
                                            {{ isset($napza->pertanyaan2['freq_opioid_P2']) && $napza->pertanyaan2['freq_opioid_P2'] == '4' ? 'checked' : '' }}>
                                        <label class="form-check-label">Tiap minggu</label>
                                    </div>
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan2[freq_opioid_P2]" value="6"
                                            {{ isset($napza->pertanyaan2['freq_opioid_P2']) && $napza->pertanyaan2['freq_opioid_P2'] == '6' ? 'checked' : '' }}>
                                        <label class="form-check-label">Selalu atau hampir selalu</label>
                                    </div>
                                    <div class="form-check ml-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan2[freq_opioid_P2]" value="0"
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <div class="d-flex align-items-center">
                                    ...
                                    <input type="text" class="form-control ml-2" name="pertanyaan2[zatlain_name_P2]" style="width: auto;"
                                        value="{{ isset($napza->pertanyaan2['zatlain_name_P2']) ? $napza->pertanyaan2['zatlain_name_P2'] : '' }}">
                                </div>
                                <div class="d-flex mt-2">
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan2[freq_zatlain_P2]" value="2"
                                            {{ isset($napza->pertanyaan2['freq_zatlain_P2']) && $napza->pertanyaan2['freq_zatlain_P2'] == '2' ? 'checked' : '' }}>
                                        <label class="form-check-label">Sekali atau dua kali</label>
                                    </div>
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan2[freq_zatlain_P2]" value="3"
                                            {{ isset($napza->pertanyaan2['freq_zatlain_P2']) && $napza->pertanyaan2['freq_zatlain_P2'] == '3' ? 'checked' : '' }}>
                                        <label class="form-check-label">Tiap bulan</label>
                                    </div>
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan2[freq_zatlain_P2]" value="4"
                                            {{ isset($napza->pertanyaan2['freq_zatlain_P2']) && $napza->pertanyaan2['freq_zatlain_P2'] == '4' ? 'checked' : '' }}>
                                        <label class="form-check-label">Tiap minggu</label>
                                    </div>
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan2[freq_zatlain_P2]" value="6"
                                            {{ isset($napza->pertanyaan2['freq_zatlain_P2']) && $napza->pertanyaan2['freq_zatlain_P2'] == '6' ? 'checked' : '' }}>
                                        <label class="form-check-label">Selalu atau hampir selalu</label>
                                    </div>
                                    <div class="form-check ml-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan2[freq_zatlain_P2]" value="0"
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="d-flex">
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan3[freq_ingin_tembakau]" value="3"
                                            {{ isset($napza->pertanyaan3['freq_ingin_tembakau']) && $napza->pertanyaan3['freq_ingin_tembakau'] == '3' ? 'checked' : '' }}>
                                        <label class="form-check-label">Sekali atau dua kali</label>
                                    </div>
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan3[freq_ingin_tembakau]" value="4"
                                            {{ isset($napza->pertanyaan3['freq_ingin_tembakau']) && $napza->pertanyaan3['freq_ingin_tembakau'] == '4' ? 'checked' : '' }}>
                                        <label class="form-check-label">Tiap bulan</label>
                                    </div>
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan3[freq_ingin_tembakau]" value="5"
                                            {{ isset($napza->pertanyaan3['freq_ingin_tembakau']) && $napza->pertanyaan3['freq_ingin_tembakau'] == '5' ? 'checked' : '' }}>
                                        <label class="form-check-label">Tiap minggu</label>
                                    </div>
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan3[freq_ingin_tembakau]" value="6"
                                            {{ isset($napza->pertanyaan3['freq_ingin_tembakau']) && $napza->pertanyaan3['freq_ingin_tembakau'] == '6' ? 'checked' : '' }}>
                                        <label class="form-check-label">Selalu atau hampir selalu</label>
                                    </div>
                                    <div class="form-check ml-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan3[freq_ingin_tembakau]" value="0"
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="d-flex">
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan3[freq_ingin_alkohol]" value="3"
                                            {{ isset($napza->pertanyaan3['freq_ingin_alkohol']) && $napza->pertanyaan3['freq_ingin_alkohol'] == '3' ? 'checked' : '' }}>
                                        <label class="form-check-label">Sekali atau dua kali</label>
                                    </div>
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan3[freq_ingin_alkohol]" value="4"
                                            {{ isset($napza->pertanyaan3['freq_ingin_alkohol']) && $napza->pertanyaan3['freq_ingin_alkohol'] == '4' ? 'checked' : '' }}>
                                        <label class="form-check-label">Tiap bulan</label>
                                    </div>
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan3[freq_ingin_alkohol]" value="5"
                                            {{ isset($napza->pertanyaan3['freq_ingin_alkohol']) && $napza->pertanyaan3['freq_ingin_alkohol'] == '5' ? 'checked' : '' }}>
                                        <label class="form-check-label">Tiap minggu</label>
                                    </div>
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan3[freq_ingin_alkohol]" value="6"
                                            {{ isset($napza->pertanyaan3['freq_ingin_alkohol']) && $napza->pertanyaan3['freq_ingin_alkohol'] == '6' ? 'checked' : '' }}>
                                        <label class="form-check-label">Selalu atau hampir selalu</label>
                                    </div>
                                    <div class="form-check ml-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan3[freq_ingin_alkohol]" value="0"
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="d-flex">
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan3[freq_ingin_kanabis]" value="3"
                                            {{ isset($napza->pertanyaan3['freq_ingin_kanabis']) && $napza->pertanyaan3['freq_ingin_kanabis'] == '3' ? 'checked' : '' }}>
                                        <label class="form-check-label">Sekali atau dua kali</label>
                                    </div>
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan3[freq_ingin_kanabis]" value="4"
                                            {{ isset($napza->pertanyaan3['freq_ingin_kanabis']) && $napza->pertanyaan3['freq_ingin_kanabis'] == '4' ? 'checked' : '' }}>
                                        <label class="form-check-label">Tiap bulan</label>
                                    </div>
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan3[freq_ingin_kanabis]" value="5"
                                            {{ isset($napza->pertanyaan3['freq_ingin_kanabis']) && $napza->pertanyaan3['freq_ingin_kanabis'] == '5' ? 'checked' : '' }}>
                                        <label class="form-check-label">Tiap minggu</label>
                                    </div>
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan3[freq_ingin_kanabis]" value="6"
                                            {{ isset($napza->pertanyaan3['freq_ingin_kanabis']) && $napza->pertanyaan3['freq_ingin_kanabis'] == '6' ? 'checked' : '' }}>
                                        <label class="form-check-label">Selalu atau hampir selalu</label>
                                    </div>
                                    <div class="form-check ml-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan3[freq_ingin_kanabis]" value="0"
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="d-flex">
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan3[freq_ingin_kokain]" value="3"
                                            {{ isset($napza->pertanyaan3['freq_ingin_kokain']) && $napza->pertanyaan3['freq_ingin_kokain'] == '3' ? 'checked' : '' }}>
                                        <label class="form-check-label">Sekali atau dua kali</label>
                                    </div>
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan3[freq_ingin_kokain]" value="4"
                                            {{ isset($napza->pertanyaan3['freq_ingin_kokain']) && $napza->pertanyaan3['freq_ingin_kokain'] == '4' ? 'checked' : '' }}>
                                        <label class="form-check-label">Tiap bulan</label>
                                    </div>
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan3[freq_ingin_kokain]" value="5"
                                            {{ isset($napza->pertanyaan3['freq_ingin_kokain']) && $napza->pertanyaan3['freq_ingin_kokain'] == '5' ? 'checked' : '' }}>
                                        <label class="form-check-label">Tiap minggu</label>
                                    </div>
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan3[freq_ingin_kokain]" value="6"
                                            {{ isset($napza->pertanyaan3['freq_ingin_kokain']) && $napza->pertanyaan3['freq_ingin_kokain'] == '6' ? 'checked' : '' }}>
                                        <label class="form-check-label">Selalu atau hampir selalu</label>
                                    </div>
                                    <div class="form-check ml-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan3[freq_ingin_kokain]" value="0"
    ...
    <div class="form-group">
        ...
        <div class="d-flex">
            <div class="form-check mr-3">
                <input type="radio" class="form-check-input" name="pertanyaan3[freq_ingin_stimulan]" value="3"
                    {{ isset($napza->pertanyaan3['freq_ingin_stimulan']) && $napza->pertanyaan3['freq_ingin_stimulan'] == '3' ? 'checked' : '' }}>
                <label class="form-check-label">Sekali atau dua kali</label>
            </div>
            <div class="form-check mr-3">
                <input type="radio" class="form-check-input" name="pertanyaan3[freq_ingin_stimulan]" value="4"
                    {{ isset($napza->pertanyaan3['freq_ingin_stimulan']) && $napza->pertanyaan3['freq_ingin_stimulan'] == '4' ? 'checked' : '' }}>
                <label class="form-check-label">Tiap bulan</label>
            </div>
            <div class="form-check mr-3">
                <input type="radio" class="form-check-input" name="pertanyaan3[freq_ingin_stimulan]" value="5"
                    {{ isset($napza->pertanyaan3['freq_ingin_stimulan']) && $napza->pertanyaan3['freq_ingin_stimulan'] == '5' ? 'checked' : '' }}>
                <label class="form-check-label">Tiap minggu</label>
            </div>
            <div class="form-check mr-3">
                <input type="radio" class="form-check-input" name="pertanyaan3[freq_ingin_stimulan]" value="6"
                    {{ isset($napza->pertanyaan3['freq_ingin_stimulan']) && $napza->pertanyaan3['freq_ingin_stimulan'] == '6' ? 'checked' : '' }}>
                <label class="form-check-label">Selalu atau hampir selalu</label>
            </div>
            <div class="form-check ml-3">
                <input type="radio" class="form-check-input" name="pertanyaan3[freq_ingin_stimulan]" value="0"
...
<div class="col-md-12">
    <div class="form-group">
        ...
        <div class="d-flex">
            <div class="form-check mr-3">
                <input type="radio" class="form-check-input" name="pertanyaan3[freq_ingin_inhalansia]" value="3"
                    {{ isset($napza->pertanyaan3['freq_ingin_inhalansia']) && $napza->pertanyaan3['freq_ingin_inhalansia'] == '3' ? 'checked' : '' }}>
                <label class="form-check-label">Sekali atau dua kali</label>
            </div>
            <div class="form-check mr-3">
                <input type="radio" class="form-check-input" name="pertanyaan3[freq_ingin_inhalansia]" value="4"
                    {{ isset($napza->pertanyaan3['freq_ingin_inhalansia']) && $napza->pertanyaan3['freq_ingin_inhalansia'] == '4' ? 'checked' : '' }}>
                <label class="form-check-label">Tiap bulan</label>
            </div>
            <div class="form-check mr-3">
                <input type="radio" class="form-check-input" name="pertanyaan3[freq_ingin_inhalansia]" value="5"
                    {{ isset($napza->pertanyaan3['freq_ingin_inhalansia']) && $napza->pertanyaan3['freq_ingin_inhalansia'] == '5' ? 'checked' : '' }}>
                <label class="form-check-label">Tiap minggu</label>
            </div>
            <div class="form-check mr-3">
                <input type="radio" class="form-check-input" name="pertanyaan3[freq_ingin_inhalansia]" value="6"
                    {{ isset($napza->pertanyaan3['freq_ingin_inhalansia']) && $napza->pertanyaan3['freq_ingin_inhalansia'] == '6' ? 'checked' : '' }}>
                <label class="form-check-label">Selalu atau hampir selalu</label>
            </div>
            <div class="form-check ml-3">
                <input type="radio" class="form-check-input" name="pertanyaan3[freq_ingin_inhalansia]" value="0"
...
<div class="col-md-12">
    <div class="form-group">
        ...
        <div class="d-flex">
            <div class="form-check mr-3">
                <input type="radio" class="form-check-input" name="pertanyaan3[freq_ingin_sedativa]" value="3"
                    {{ isset($napza->pertanyaan3['freq_ingin_sedativa']) && $napza->pertanyaan3['freq_ingin_sedativa'] == '3' ? 'checked' : '' }}>
                <label class="form-check-label">Sekali atau dua kali</label>
            </div>
            <div class="form-check mr-3">
                <input type="radio" class="form-check-input" name="pertanyaan3[freq_ingin_sedativa]" value="4"
                    {{ isset($napza->pertanyaan3['freq_ingin_sedativa']) && $napza->pertanyaan3['freq_ingin_sedativa'] == '4' ? 'checked' : '' }}>
                <label class="form-check-label">Tiap bulan</label>
            </div>
            <div class="form-check mr-3">
                <input type="radio" class="form-check-input" name="pertanyaan3[freq_ingin_sedativa]" value="5"
                    {{ isset($napza->pertanyaan3['freq_ingin_sedativa']) && $napza->pertanyaan3['freq_ingin_sedativa'] == '5' ? 'checked' : '' }}>
                <label class="form-check-label">Tiap minggu</label>
            </div>
            <div class="form-check mr-3">
                <input type="radio" class="form-check-input" name="pertanyaan3[freq_ingin_sedativa]" value="6"
                    {{ isset($napza->pertanyaan3['freq_ingin_sedativa']) && $napza->pertanyaan3['freq_ingin_sedativa'] == '6' ? 'checked' : '' }}>
                <label class="form-check-label">Selalu atau hampir selalu</label>
            </div>
            <div class="form-check ml-3">
                <input type="radio" class="form-check-input" name="pertanyaan3[freq_ingin_sedativa]" value="0"
...
<div class="col-md-12">
    <div class="form-group">
        ...
        <div class="d-flex">
            <div class="form-check mr-3">
                <input type="radio" class="form-check-input" name="pertanyaan3[freq_ingin_halusinogen]" value="3"
                    {{ isset($napza->pertanyaan3['freq_ingin_halusinogen']) && $napza->pertanyaan3['freq_ingin_halusinogen'] == '3' ? 'checked' : '' }}>
                <label class="form-check-label">Sekali atau dua kali</label>
            </div>
            <div class="form-check mr-3">
                <input type="radio" class="form-check-input" name="pertanyaan3[freq_ingin_halusinogen]" value="4"
                    {{ isset($napza->pertanyaan3['freq_ingin_halusinogen']) && $napza->pertanyaan3['freq_ingin_halusinogen'] == '4' ? 'checked' : '' }}>
                <label class="form-check-label">Tiap bulan</label>
            </div>
            <div class="form-check mr-3">
                <input type="radio" class="form-check-input" name="pertanyaan3[freq_ingin_halusinogen]" value="5"
                    {{ isset($napza->pertanyaan3['freq_ingin_halusinogen']) && $napza->pertanyaan3['freq_ingin_halusinogen'] == '5' ? 'checked' : '' }}>
                <label class="form-check-label">Tiap minggu</label>
            </div>
            <div class="form-check mr-3">
                <input type="radio" class="form-check-input" name="pertanyaan3[freq_ingin_halusinogen]" value="6"
                    {{ isset($napza->pertanyaan3['freq_ingin_halusinogen']) && $napza->pertanyaan3['freq_ingin_halusinogen'] == '6' ? 'checked' : '' }}>
                <label class="form-check-label">Selalu atau hampir selalu</label>
            </div>
            <div class="form-check ml-3">
                <input type="radio" class="form-check-input" name="pertanyaan3[freq_ingin_halusinogen]" value="0"
...
<div class="col-md-12">
    <div class="form-group">
        ...
        <div class="d-flex">
            <div class="form-check mr-3">
                <input type="radio" class="form-check-input" name="pertanyaan3[freq_ingin_opioid]" value="3"
                    {{ isset($napza->pertanyaan3['freq_ingin_opioid']) && $napza->pertanyaan3['freq_ingin_opioid'] == '3' ? 'checked' : '' }}>
                <label class="form-check-label">Sekali atau dua kali</label>
            </div>
            <div class="form-check mr-3">
                <input type="radio" class="form-check-input" name="pertanyaan3[freq_ingin_opioid]" value="4"
                    {{ isset($napza->pertanyaan3['freq_ingin_opioid']) && $napza->pertanyaan3['freq_ingin_opioid'] == '4' ? 'checked' : '' }}>
                <label class="form-check-label">Tiap bulan</label>
            </div>
            <div class="form-check mr-3">
                <input type="radio" class="form-check-input" name="pertanyaan3[freq_ingin_opioid]" value="5"
                    {{ isset($napza->pertanyaan3['freq_ingin_opioid']) && $napza->pertanyaan3['freq_ingin_opioid'] == '5' ? 'checked' : '' }}>
                <label class="form-check-label">Tiap minggu</label>
            </div>
            <div class="form-check mr-3">
                <input type="radio" class="form-check-input" name="pertanyaan3[freq_ingin_opioid]" value="6"
                    {{ isset($napza->pertanyaan3['freq_ingin_opioid']) && $napza->pertanyaan3['freq_ingin_opioid'] == '6' ? 'checked' : '' }}>
                <label class="form-check-label">Selalu atau hampir selalu</label>
            </div>
            <div class="form-check ml-3">
                <input type="radio" class="form-check-input" name="pertanyaan3[freq_ingin_opioid]" value="0"
...
<div class="col-md-12">
    <div class="form-group">
        <div class="d-flex align-items-center">
            <label>j. Zat-lain: sebutkan</label>
            <input type="text" class="form-control ml-2" name="pertanyaan3[freq_ingin_zat_lain]"
                value="{{ isset($napza->pertanyaan3['freq_ingin_zat_lain']) ? $napza->pertanyaan3['freq_ingin_zat_lain'] : '' }}"
                style="width: auto;">
        </div>
        <div class="d-flex mt-2">
            <div class="form-check mr-3">
                <input type="radio" class="form-check-input" name="pertanyaan3[freq_ingin_zat_lain_freq]" value="3"
                    {{ isset($napza->pertanyaan3['freq_ingin_zat_lain_freq']) && $napza->pertanyaan3['freq_ingin_zat_lain_freq'] == '3' ? 'checked' : '' }}>
                <label class="form-check-label">Sekali atau dua kali</label>
            </div>
            <div class="form-check mr-3">
                <input type="radio" class="form-check-input" name="pertanyaan3[freq_ingin_zat_lain_freq]" value="4"
                    {{ isset($napza->pertanyaan3['freq_ingin_zat_lain_freq']) && $napza->pertanyaan3['freq_ingin_zat_lain_freq'] == '4' ? 'checked' : '' }}>
                <label class="form-check-label">Tiap bulan</label>
            </div>
            <div class="form-check mr-3">
                <input type="radio" class="form-check-input" name="pertanyaan3[freq_ingin_zat_lain_freq]" value="5"
                    {{ isset($napza->pertanyaan3['freq_ingin_zat_lain_freq']) && $napza->pertanyaan3['freq_ingin_zat_lain_freq'] == '5' ? 'checked' : '' }}>
                <label class="form-check-label">Tiap minggu</label>
            </div>
            <div class="form-check mr-3">
                <input type="radio" class="form-check-input" name="pertanyaan3[freq_ingin_zat_lain_freq]" value="6"
                    {{ isset($napza->pertanyaan3['freq_ingin_zat_lain_freq']) && $napza->pertanyaan3['freq_ingin_zat_lain_freq'] == '6' ? 'checked' : '' }}>
                <label class="form-check-label">Selalu atau hampir selalu</label>
            </div>
            <div class="form-check ml-3">
                <input type="radio" class="form-check-input" name="pertanyaan3[freq_ingin_zat_lain_freq]" value="0"
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="d-flex">
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan4[freq_masalah_tembakau]" value="4"
                                    ...
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan4[freq_masalah_tembakau]" value="5"
                                            {{ isset($napza->pertanyaan4['freq_masalah_tembakau']) && $napza->pertanyaan4['freq_masalah_tembakau'] == '5' ? 'checked' : '' }}>
                                        <label class="form-check-label">Tiap bulan</label>
                                    </div>
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan4[freq_masalah_tembakau]" value="6"
                                            {{ isset($napza->pertanyaan4['freq_masalah_tembakau']) && $napza->pertanyaan4['freq_masalah_tembakau'] == '6' ? 'checked' : '' }}>
                                        <label class="form-check-label">Tiap minggu</label>
                                    </div>
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan4[freq_masalah_tembakau]" value="7"
                                    ...
                                    <div class="form-check ml-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan4[freq_masalah_tembakau]" value="0"
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="d-flex">
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan4[freq_masalah_alkohol]" value="4"
                                            {{ isset($napza->pertanyaan4['freq_masalah_alkohol']) && $napza->pertanyaan4['freq_masalah_alkohol'] == '4' ? 'checked' : '' }}>
                                        <label class="form-check-label">Satu atau dua kali</label>
                                    </div>
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan4[freq_masalah_alkohol]" value="5"
                                            {{ isset($napza->pertanyaan4['freq_masalah_alkohol']) && $napza->pertanyaan4['freq_masalah_alkohol'] == '5' ? 'checked' : '' }}>
                                        <label class="form-check-label">Tiap bulan</label>
                                    </div>
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan4[freq_masalah_alkohol]" value="6"
                                            {{ isset($napza->pertanyaan4['freq_masalah_alkohol']) && $napza->pertanyaan4['freq_masalah_alkohol'] == '6' ? 'checked' : '' }}>
                                        <label class="form-check-label">Tiap minggu</label>
                                    </div>
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan4[freq_masalah_alkohol]" value="7"
                                            {{ isset($napza->pertanyaan4['freq_masalah_alkohol']) && $napza->pertanyaan4['freq_masalah_alkohol'] == '7' ? 'checked' : '' }}>
                                        <label class="form-check-label">Harian atau hampir tiap hari</label>
                                    </div>
                                    <div class="form-check ml-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan4[freq_masalah_alkohol]" value="0"
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="d-flex">
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan4[freq_masalah_kanabis]" value="4"
                                            {{ isset($napza->pertanyaan4['freq_masalah_kanabis']) && $napza->pertanyaan4['freq_masalah_kanabis'] == '4' ? 'checked' : '' }}>
                                        <label class="form-check-label">Satu atau dua kali</label>
                                    </div>
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan4[freq_masalah_kanabis]" value="5"
                                            {{ isset($napza->pertanyaan4['freq_masalah_kanabis']) && $napza->pertanyaan4['freq_masalah_kanabis'] == '5' ? 'checked' : '' }}>
                                        <label class="form-check-label">Tiap bulan</label>
                                    </div>
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan4[freq_masalah_kanabis]" value="6"
                                            {{ isset($napza->pertanyaan4['freq_masalah_kanabis']) && $napza->pertanyaan4['freq_masalah_kanabis'] == '6' ? 'checked' : '' }}>
                                        <label class="form-check-label">Tiap minggu</label>
                                    </div>
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan4[freq_masalah_kanabis]" value="7"
                                            {{ isset($napza->pertanyaan4['freq_masalah_kanabis']) && $napza->pertanyaan4['freq_masalah_kanabis'] == '7' ? 'checked' : '' }}>
                                        <label class="form-check-label">Harian atau hampir tiap hari</label>
                                    </div>
                                    <div class="form-check ml-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan4[freq_masalah_kanabis]" value="0"
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="d-flex">
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan4[freq_masalah_kokain]" value="4"
                                            {{ isset($napza->pertanyaan4['freq_masalah_kokain']) && $napza->pertanyaan4['freq_masalah_kokain'] == '4' ? 'checked' : '' }}>
                                        <label class="form-check-label">Satu atau dua kali</label>
                                    </div>
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan4[freq_masalah_kokain]" value="5"
                                            {{ isset($napza->pertanyaan4['freq_masalah_kokain']) && $napza->pertanyaan4['freq_masalah_kokain'] == '5' ? 'checked' : '' }}>
                                        <label class="form-check-label">Tiap bulan</label>
                                    </div>
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan4[freq_masalah_kokain]" value="6"
                                            {{ isset($napza->pertanyaan4['freq_masalah_kokain']) && $napza->pertanyaan4['freq_masalah_kokain'] == '6' ? 'checked' : '' }}>
                                        <label class="form-check-label">Tiap minggu</label>
                                    </div>
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan4[freq_masalah_kokain]" value="7"
                                            {{ isset($napza->pertanyaan4['freq_masalah_kokain']) && $napza->pertanyaan4['freq_masalah_kokain'] == '7' ? 'checked' : '' }}>
                                        <label class="form-check-label">Harian atau hampir tiap hari</label>
                                    </div>
                                    <div class="form-check ml-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan4[freq_masalah_kokain]" value="0"
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="d-flex">
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan4[freq_masalah_stimulan]" value="4"
                                            {{ isset($napza->pertanyaan4['freq_masalah_stimulan']) && $napza->pertanyaan4['freq_masalah_stimulan'] == '4' ? 'checked' : '' }}>
                                        <label class="form-check-label">Satu atau dua kali</label>
                                    </div>
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan4[freq_masalah_stimulan]" value="5"
                                            {{ isset($napza->pertanyaan4['freq_masalah_stimulan']) && $napza->pertanyaan4['freq_masalah_stimulan'] == '5' ? 'checked' : '' }}>
                                        <label class="form-check-label">Tiap bulan</label>
                                    </div>
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan4[freq_masalah_stimulan]" value="6"
                                            {{ isset($napza->pertanyaan4['freq_masalah_stimulan']) && $napza->pertanyaan4['freq_masalah_stimulan'] == '6' ? 'checked' : '' }}>
                                        <label class="form-check-label">Tiap minggu</label>
                                    </div>
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan4[freq_masalah_stimulan]" value="7"
                                            {{ isset($napza->pertanyaan4['freq_masalah_stimulan']) && $napza->pertanyaan4['freq_masalah_stimulan'] == '7' ? 'checked' : '' }}>
                                        <label class="form-check-label">Harian atau hampir tiap hari</label>
                                    </div>
                                    <div class="form-check ml-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan4[freq_masalah_stimulan]" value="0"
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="d-flex">
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan4[freq_masalah_inhalansia]" value="4"
                                            {{ isset($napza->pertanyaan4['freq_masalah_inhalansia']) && $napza->pertanyaan4['freq_masalah_inhalansia'] == '4' ? 'checked' : '' }}>
                                        <label class="form-check-label">Satu atau dua kali</label>
                                    </div>
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan4[freq_masalah_inhalansia]" value="5"
                                            {{ isset($napza->pertanyaan4['freq_masalah_inhalansia']) && $napza->pertanyaan4['freq_masalah_inhalansia'] == '5' ? 'checked' : '' }}>
                                        <label class="form-check-label">Tiap bulan</label>
                                    </div>
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan4[freq_masalah_inhalansia]" value="6"
                                            {{ isset($napza->pertanyaan4['freq_masalah_inhalansia']) && $napza->pertanyaan4['freq_masalah_inhalansia'] == '6' ? 'checked' : '' }}>
                                        <label class="form-check-label">Tiap minggu</label>
                                    </div>
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan4[freq_masalah_inhalansia]" value="7"
                                            {{ isset($napza->pertanyaan4['freq_masalah_inhalansia']) && $napza->pertanyaan4['freq_masalah_inhalansia'] == '7' ? 'checked' : '' }}>
                                        <label class="form-check-label">Harian atau hampir tiap hari</label>
                                    </div>
                                    <div class="form-check ml-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan4[freq_masalah_inhalansia]" value="0"
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="d-flex">
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan4[freq_masalah_sedativa]" value="4"
                                            {{ isset($napza->pertanyaan4['freq_masalah_sedativa']) && $napza->pertanyaan4['freq_masalah_sedativa'] == '4' ? 'checked' : '' }}>
                                        <label class="form-check-label">Satu atau dua kali</label>
                                    </div>
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan4[freq_masalah_sedativa]" value="5"
                                            {{ isset($napza->pertanyaan4['freq_masalah_sedativa']) && $napza->pertanyaan4['freq_masalah_sedativa'] == '5' ? 'checked' : '' }}>
                                        <label class="form-check-label">Tiap bulan</label>
                                    </div>
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan4[freq_masalah_sedativa]" value="6"
                                            {{ isset($napza->pertanyaan4['freq_masalah_sedativa']) && $napza->pertanyaan4['freq_masalah_sedativa'] == '6' ? 'checked' : '' }}>
                                        <label class="form-check-label">Tiap minggu</label>
                                    </div>
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan4[freq_masalah_sedativa]" value="7"
                                            {{ isset($napza->pertanyaan4['freq_masalah_sedativa']) && $napza->pertanyaan4['freq_masalah_sedativa'] == '7' ? 'checked' : '' }}>
                                        <label class="form-check-label">Harian atau hampir tiap hari</label>
                                    </div>
                                    <div class="form-check ml-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan4[freq_masalah_sedativa]" value="0"
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="d-flex">
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan4[freq_masalah_halusinogen]" value="4"
                                            {{ isset($napza->pertanyaan4['freq_masalah_halusinogen']) && $napza->pertanyaan4['freq_masalah_halusinogen'] == '4' ? 'checked' : '' }}>
                                        <label class="form-check-label">Satu atau dua kali</label>
                                    </div>
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan4[freq_masalah_halusinogen]" value="5"
                                            {{ isset($napza->pertanyaan4['freq_masalah_halusinogen']) && $napza->pertanyaan4['freq_masalah_halusinogen'] == '5' ? 'checked' : '' }}>
                                        <label class="form-check-label">Tiap bulan</label>
                                    </div>
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan4[freq_masalah_halusinogen]" value="6"
                                            {{ isset($napza->pertanyaan4['freq_masalah_halusinogen']) && $napza->pertanyaan4['freq_masalah_halusinogen'] == '6' ? 'checked' : '' }}>
                                        <label class="form-check-label">Tiap minggu</label>
                                    </div>
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan4[freq_masalah_halusinogen]" value="7"
                                            {{ isset($napza->pertanyaan4['freq_masalah_halusinogen']) && $napza->pertanyaan4['freq_masalah_halusinogen'] == '7' ? 'checked' : '' }}>
                                        <label class="form-check-label">Harian atau hampir tiap hari</label>
                                    </div>
                                    <div class="form-check ml-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan4[freq_masalah_halusinogen]" value="0"
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="d-flex">
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan5[freq_masalah_opioid]" value="4"
                                            {{ isset($napza->pertanyaan5['freq_masalah_opioid']) && $napza->pertanyaan5['freq_masalah_opioid'] == '4' ? 'checked' : '' }}>
                                        <label class="form-check-label">Satu atau dua kali</label>
                                    </div>
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan5[freq_masalah_opioid]" value="5"
                                            {{ isset($napza->pertanyaan5['freq_masalah_opioid']) && $napza->pertanyaan5['freq_masalah_opioid'] == '5' ? 'checked' : '' }}>
                                        <label class="form-check-label">Tiap bulan</label>
                                    </div>
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan5[freq_masalah_opioid]" value="6"
                                            {{ isset($napza->pertanyaan5['freq_masalah_opioid']) && $napza->pertanyaan5['freq_masalah_opioid'] == '6' ? 'checked' : '' }}>
                                        <label class="form-check-label">Tiap minggu</label>
                                    </div>
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan5[freq_masalah_opioid]" value="7"
                                            {{ isset($napza->pertanyaan5['freq_masalah_opioid']) && $napza->pertanyaan5['freq_masalah_opioid'] == '7' ? 'checked' : '' }}>
                                        <label class="form-check-label">Harian atau hampir tiap hari</label>
                                    </div>
                                    <div class="form-check ml-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan5[freq_masalah_opioid]" value="0"
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <div class="d-flex align-items-center">
                                    <label>j. Zat-lain: sebutkan</label>
                                    <input type="text" class="form-control ml-2" name="pertanyaan5[freq_masalah_zat_lain]" value="{{ old('pertanyaan5.freq_masalah_zat_lain', $napza->pertanyaan5['freq_masalah_zat_lain'] ?? '') }}" style="width: auto;">
                                </div>
                                <div class="d-flex mt-2">
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan5[freq_masalah_zat_lain_freq]" value="4"
                                            {{ isset($napza->pertanyaan5['freq_masalah_zat_lain_freq']) && $napza->pertanyaan5['freq_masalah_zat_lain_freq'] == '4' ? 'checked' : '' }}>
                                        <label class="form-check-label">Satu atau dua kali</label>
                                    </div>
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan5[freq_masalah_zat_lain_freq]" value="5"
                                            {{ isset($napza->pertanyaan5['freq_masalah_zat_lain_freq']) && $napza->pertanyaan5['freq_masalah_zat_lain_freq'] == '5' ? 'checked' : '' }}>
                                        <label class="form-check-label">Tiap bulan</label>
                                    </div>
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan5[freq_masalah_zat_lain_freq]" value="6"
                                            {{ isset($napza->pertanyaan5['freq_masalah_zat_lain_freq']) && $napza->pertanyaan5['freq_masalah_zat_lain_freq'] == '6' ? 'checked' : '' }}>
                                        <label class="form-check-label">Tiap minggu</label>
                                    </div>
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan5[freq_masalah_zat_lain_freq]" value="7"
                                            {{ isset($napza->pertanyaan5['freq_masalah_zat_lain_freq']) && $napza->pertanyaan5['freq_masalah_zat_lain_freq'] == '7' ? 'checked' : '' }}>
                                        <label class="form-check-label">Harian atau hampir tiap hari</label>
                                    </div>
                                    <div class="form-check ml-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan5[freq_masalah_zat_lain_freq]" value="0"
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="d-flex">
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan5[freq_gagal_tembakau]" value="5"
                                            {{ isset($napza->pertanyaan5['freq_gagal_tembakau']) && $napza->pertanyaan5['freq_gagal_tembakau'] == '5' ? 'checked' : '' }}>
                                        <label class="form-check-label">Satu atau dua kali</label>
                                    </div>
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan5[freq_gagal_tembakau]" value="6"
                                            {{ isset($napza->pertanyaan5['freq_gagal_tembakau']) && $napza->pertanyaan5['freq_gagal_tembakau'] == '6' ? 'checked' : '' }}>
                                        <label class="form-check-label">Tiap bulan</label>
                                    </div>
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan5[freq_gagal_tembakau]" value="7"
                                            {{ isset($napza->pertanyaan5['freq_gagal_tembakau']) && $napza->pertanyaan5['freq_gagal_tembakau'] == '7' ? 'checked' : '' }}>
                                        <label class="form-check-label">Tiap minggu</label>
                                    </div>
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan5[freq_gagal_tembakau]" value="8"
                                            {{ isset($napza->pertanyaan5['freq_gagal_tembakau']) && $napza->pertanyaan5['freq_gagal_tembakau'] == '8' ? 'checked' : '' }}>
                                        <label class="form-check-label">Harian atau hampir tiap hari</label>
                                    </div>
                                    <div class="form-check ml-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan5[freq_gagal_tembakau]" value="0"
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="d-flex">
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan5[freq_gagal_alkohol]" value="5"
                                            {{ isset($napza->pertanyaan5['freq_gagal_alkohol']) && $napza->pertanyaan5['freq_gagal_alkohol'] == '5' ? 'checked' : '' }}>
                                        <label class="form-check-label">Satu atau dua kali</label>
                                    </div>
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan5[freq_gagal_alkohol]" value="6"
                                            {{ isset($napza->pertanyaan5['freq_gagal_alkohol']) && $napza->pertanyaan5['freq_gagal_alkohol'] == '6' ? 'checked' : '' }}>
                                        <label class="form-check-label">Tiap bulan</label>
                                    </div>
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan5[freq_gagal_alkohol]" value="7"
                                            {{ isset($napza->pertanyaan5['freq_gagal_alkohol']) && $napza->pertanyaan5['freq_gagal_alkohol'] == '7' ? 'checked' : '' }}>
                                        <label class="form-check-label">Tiap minggu</label>
                                    </div>
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan5[freq_gagal_alkohol]" value="8"
                                            {{ isset($napza->pertanyaan5['freq_gagal_alkohol']) && $napza->pertanyaan5['freq_gagal_alkohol'] == '8' ? 'checked' : '' }}>
                                        <label class="form-check-label">Harian atau hampir tiap hari</label>
                                    </div>
                                    <div class="form-check ml-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan5[freq_gagal_alkohol]" value="0"
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="d-flex">
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan5[freq_gagal_kanabis]" value="5"
                                            {{ isset($napza->pertanyaan5['freq_gagal_kanabis']) && $napza->pertanyaan5['freq_gagal_kanabis'] == '5' ? 'checked' : '' }}>
                                        <label class="form-check-label">Satu atau dua kali</label>
                                    </div>
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan5[freq_gagal_kanabis]" value="6"
                                            {{ isset($napza->pertanyaan5['freq_gagal_kanabis']) && $napza->pertanyaan5['freq_gagal_kanabis'] == '6' ? 'checked' : '' }}>
                                        <label class="form-check-label">Tiap bulan</label>
                                    </div>
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan5[freq_gagal_kanabis]" value="7"
                                            {{ isset($napza->pertanyaan5['freq_gagal_kanabis']) && $napza->pertanyaan5['freq_gagal_kanabis'] == '7' ? 'checked' : '' }}>
                                        <label class="form-check-label">Tiap minggu</label>
                                    </div>
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan5[freq_gagal_kanabis]" value="8"
                                            {{ isset($napza->pertanyaan5['freq_gagal_kanabis']) && $napza->pertanyaan5['freq_gagal_kanabis'] == '8' ? 'checked' : '' }}>
                                        <label class="form-check-label">Harian atau hampir tiap hari</label>
                                    </div>
                                    <div class="form-check ml-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan5[freq_gagal_kanabis]" value="0"
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="d-flex">
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan5[freq_gagal_kokain]" value="5"
                                            {{ isset($napza->pertanyaan5['freq_gagal_kokain']) && $napza->pertanyaan5['freq_gagal_kokain'] == '5' ? 'checked' : '' }}>
                                        <label class="form-check-label">Satu atau dua kali</label>
                                    </div>
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan5[freq_gagal_kokain]" value="6"
                                            {{ isset($napza->pertanyaan5['freq_gagal_kokain']) && $napza->pertanyaan5['freq_gagal_kokain'] == '6' ? 'checked' : '' }}>
                                        <label class="form-check-label">Tiap bulan</label>
                                    </div>
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan5[freq_gagal_kokain]" value="7"
                                            {{ isset($napza->pertanyaan5['freq_gagal_kokain']) && $napza->pertanyaan5['freq_gagal_kokain'] == '7' ? 'checked' : '' }}>
                                        <label class="form-check-label">Tiap minggu</label>
                                    </div>
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan5[freq_gagal_kokain]" value="8"
                                            {{ isset($napza->pertanyaan5['freq_gagal_kokain']) && $napza->pertanyaan5['freq_gagal_kokain'] == '8' ? 'checked' : '' }}>
                                        <label class="form-check-label">Harian atau hampir tiap hari</label>
                                    </div>
                                    <div class="form-check ml-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan5[freq_gagal_kokain]" value="0"
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="d-flex">
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan5[freq_gagal_stimulan]" value="5"
                                            {{ isset($napza->pertanyaan5['freq_gagal_stimulan']) && $napza->pertanyaan5['freq_gagal_stimulan'] == '5' ? 'checked' : '' }}>
                                        <label class="form-check-label">Satu atau dua kali</label>
                                    </div>
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan5[freq_gagal_stimulan]" value="6"
                                            {{ isset($napza->pertanyaan5['freq_gagal_stimulan']) && $napza->pertanyaan5['freq_gagal_stimulan'] == '6' ? 'checked' : '' }}>
                                        <label class="form-check-label">Tiap bulan</label>
                                    </div>
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan5[freq_gagal_stimulan]" value="7"
                                            {{ isset($napza->pertanyaan5['freq_gagal_stimulan']) && $napza->pertanyaan5['freq_gagal_stimulan'] == '7' ? 'checked' : '' }}>
                                        <label class="form-check-label">Tiap minggu</label>
                                    </div>
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan5[freq_gagal_stimulan]" value="8"
                                            {{ isset($napza->pertanyaan5['freq_gagal_stimulan']) && $napza->pertanyaan5['freq_gagal_stimulan'] == '8' ? 'checked' : '' }}>
                                        <label class="form-check-label">Harian atau hampir tiap hari</label>
                                    </div>
                                    <div class="form-check ml-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan5[freq_gagal_stimulan]" value="0"
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="d-flex">
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan5[freq_gagal_inhalansia]" value="5"
                                            {{ isset($napza->pertanyaan5['freq_gagal_inhalansia']) && $napza->pertanyaan5['freq_gagal_inhalansia'] == '5' ? 'checked' : '' }}>
                                        <label class="form-check-label">Satu atau dua kali</label>
                                    </div>
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan5[freq_gagal_inhalansia]" value="6"
                                            {{ isset($napza->pertanyaan5['freq_gagal_inhalansia']) && $napza->pertanyaan5['freq_gagal_inhalansia'] == '6' ? 'checked' : '' }}>
                                        <label class="form-check-label">Tiap bulan</label>
                                    </div>
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan5[freq_gagal_inhalansia]" value="7"
                                            {{ isset($napza->pertanyaan5['freq_gagal_inhalansia']) && $napza->pertanyaan5['freq_gagal_inhalansia'] == '7' ? 'checked' : '' }}>
                                        <label class="form-check-label">Tiap minggu</label>
                                    </div>
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan5[freq_gagal_inhalansia]" value="8"
                                            {{ isset($napza->pertanyaan5['freq_gagal_inhalansia']) && $napza->pertanyaan5['freq_gagal_inhalansia'] == '8' ? 'checked' : '' }}>
                                        <label class="form-check-label">Harian atau hampir tiap hari</label>
                                    </div>
                                    <div class="form-check ml-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan5[freq_gagal_inhalansia]" value="0"
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="d-flex">
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan5[freq_gagal_sedativa]" value="5"
                                            {{ isset($napza->pertanyaan5['freq_gagal_sedativa']) && $napza->pertanyaan5['freq_gagal_sedativa'] == '5' ? 'checked' : '' }}>
                                        <label class="form-check-label">Satu atau dua kali</label>
                                    </div>
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan5[freq_gagal_sedativa]" value="6"
                                            {{ isset($napza->pertanyaan5['freq_gagal_sedativa']) && $napza->pertanyaan5['freq_gagal_sedativa'] == '6' ? 'checked' : '' }}>
                                        <label class="form-check-label">Tiap bulan</label>
                                    </div>
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan5[freq_gagal_sedativa]" value="7"
                                            {{ isset($napza->pertanyaan5['freq_gagal_sedativa']) && $napza->pertanyaan5['freq_gagal_sedativa'] == '7' ? 'checked' : '' }}>
                                        <label class="form-check-label">Tiap minggu</label>
                                    </div>
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan5[freq_gagal_sedativa]" value="8"
                                            {{ isset($napza->pertanyaan5['freq_gagal_sedativa']) && $napza->pertanyaan5['freq_gagal_sedativa'] == '8' ? 'checked' : '' }}>
                                        <label class="form-check-label">Harian atau hampir tiap hari</label>
                                    </div>
                                    <div class="form-check ml-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan5[freq_gagal_sedativa]" value="0"
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="d-flex">
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan5[freq_gagal_halusinogen]" value="5"
                                            {{ isset($napza->pertanyaan5['freq_gagal_halusinogen']) && $napza->pertanyaan5['freq_gagal_halusinogen'] == '5' ? 'checked' : '' }}>
                                        <label class="form-check-label">Satu atau dua kali</label>
                                    </div>
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan5[freq_gagal_halusinogen]" value="6"
                                            {{ isset($napza->pertanyaan5['freq_gagal_halusinogen']) && $napza->pertanyaan5['freq_gagal_halusinogen'] == '6' ? 'checked' : '' }}>
                                        <label class="form-check-label">Tiap bulan</label>
                                    </div>
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan5[freq_gagal_halusinogen]" value="7"
                                            {{ isset($napza->pertanyaan5['freq_gagal_halusinogen']) && $napza->pertanyaan5['freq_gagal_halusinogen'] == '7' ? 'checked' : '' }}>
                                        <label class="form-check-label">Tiap minggu</label>
                                    </div>
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan5[freq_gagal_halusinogen]" value="8"
                                            {{ isset($napza->pertanyaan5['freq_gagal_halusinogen']) && $napza->pertanyaan5['freq_gagal_halusinogen'] == '8' ? 'checked' : '' }}>
                                        <label class="form-check-label">Harian atau hampir tiap hari</label>
                                    </div>
                                    <div class="form-check ml-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan5[freq_gagal_halusinogen]" value="0"
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="d-flex">
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan6[freq_gagal_opioid]" value="5"
                                            {{ isset($napza->pertanyaan6['freq_gagal_opioid']) && $napza->pertanyaan6['freq_gagal_opioid'] == '5' ? 'checked' : '' }}>
                                        <label class="form-check-label">Satu atau dua kali</label>
                                    </div>
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan6[freq_gagal_opioid]" value="6"
                                            {{ isset($napza->pertanyaan6['freq_gagal_opioid']) && $napza->pertanyaan6['freq_gagal_opioid'] == '6' ? 'checked' : '' }}>
                                        <label class="form-check-label">Tiap bulan</label>
                                    </div>
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan6[freq_gagal_opioid]" value="7"
                                            {{ isset($napza->pertanyaan6['freq_gagal_opioid']) && $napza->pertanyaan6['freq_gagal_opioid'] == '7' ? 'checked' : '' }}>
                                        <label class="form-check-label">Tiap minggu</label>
                                    </div>
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan6[freq_gagal_opioid]" value="8"
                                            {{ isset($napza->pertanyaan6['freq_gagal_opioid']) && $napza->pertanyaan6['freq_gagal_opioid'] == '8' ? 'checked' : '' }}>
                                        <label class="form-check-label">Harian atau hampir tiap hari</label>
                                    </div>
                                    <div class="form-check ml-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan6[freq_gagal_opioid]" value="0"
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <div class="d-flex align-items-center">
                                    <label>j. Zat-lain: sebutkan</label>
                                    <input type="text" class="form-control ml-2" name="pertanyaan6[freq_gagal_zat_lain]" style="width: auto;" 
                                        value="{{ isset($napza->pertanyaan6['freq_gagal_zat_lain']) ? $napza->pertanyaan6['freq_gagal_zat_lain'] : '' }}">
                                </div>
                                <div class="d-flex mt-2">
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan6[freq_gagal_zat_lain_freq]" value="5"
                                            {{ isset($napza->pertanyaan6['freq_gagal_zat_lain_freq']) && $napza->pertanyaan6['freq_gagal_zat_lain_freq'] == '5' ? 'checked' : '' }}>
                                        <label class="form-check-label">Satu atau dua kali</label>
                                    </div>
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan6[freq_gagal_zat_lain_freq]" value="6"
                                            {{ isset($napza->pertanyaan6['freq_gagal_zat_lain_freq']) && $napza->pertanyaan6['freq_gagal_zat_lain_freq'] == '6' ? 'checked' : '' }}>
                                        <label class="form-check-label">Tiap bulan</label>
                                    </div>
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan6[freq_gagal_zat_lain_freq]" value="7"
                                            {{ isset($napza->pertanyaan6['freq_gagal_zat_lain_freq']) && $napza->pertanyaan6['freq_gagal_zat_lain_freq'] == '7' ? 'checked' : '' }}>
                                        <label class="form-check-label">Tiap minggu</label>
                                    </div>
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan6[freq_gagal_zat_lain_freq]" value="8"
                                            {{ isset($napza->pertanyaan6['freq_gagal_zat_lain_freq']) && $napza->pertanyaan6['freq_gagal_zat_lain_freq'] == '8' ? 'checked' : '' }}>
                                        <label class="form-check-label">Harian atau hampir tiap hari</label>
                                    </div>
                                    <div class="form-check ml-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan6[freq_gagal_zat_lain_freq]" value="0"
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="d-flex">
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan6[freq_khawatir_tembakau]" value="3"
                                    ...
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan6[freq_khawatir_tembakau]" value="6"
                                    ...
                                    <div class="form-check ml-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan6[freq_khawatir_tembakau]" value="0"
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="d-flex">
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan6[freq_khawatir_alkohol]" value="3"
                                            {{ isset($napza->pertanyaan6['freq_khawatir_alkohol']) && $napza->pertanyaan6['freq_khawatir_alkohol'] == '3' ? 'checked' : '' }}>
                                        <label class="form-check-label">Pernah, tapi tidak dalam 3 bulan terakhir</label>
                                    </div>
                        
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan6[freq_khawatir_alkohol]" value="6"
                                            {{ isset($napza->pertanyaan6['freq_khawatir_alkohol']) && $napza->pertanyaan6['freq_khawatir_alkohol'] == '6' ? 'checked' : '' }}>
                                        <label class="form-check-label">Pernah, dalam 3 bulan terakhir</label>
                                    </div>
                        
                                    <div class="form-check ml-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan6[freq_khawatir_alkohol]" value="0"
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="d-flex">
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan6[freq_khawatir_kanabis]" value="3"
                                            {{ isset($napza->pertanyaan6['freq_khawatir_kanabis']) && $napza->pertanyaan6['freq_khawatir_kanabis'] == '3' ? 'checked' : '' }}>
                                        <label class="form-check-label">Pernah, tapi tidak dalam 3 bulan terakhir</label>
                                    </div>
                        
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan6[freq_khawatir_kanabis]" value="6"
                                            {{ isset($napza->pertanyaan6['freq_khawatir_kanabis']) && $napza->pertanyaan6['freq_khawatir_kanabis'] == '6' ? 'checked' : '' }}>
                                        <label class="form-check-label">Pernah, dalam 3 bulan terakhir</label>
                                    </div>
                        
                                    <div class="form-check ml-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan6[freq_khawatir_kanabis]" value="0"
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="d-flex">
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan6[freq_khawatir_kokain]" value="3"
                                            {{ isset($napza->pertanyaan6['freq_khawatir_kokain']) && $napza->pertanyaan6['freq_khawatir_kokain'] == '3' ? 'checked' : '' }}>
                                        <label class="form-check-label">Pernah, tapi tidak dalam 3 bulan terakhir</label>
                                    </div>
                        
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan6[freq_khawatir_kokain]" value="6"
                                            {{ isset($napza->pertanyaan6['freq_khawatir_kokain']) && $napza->pertanyaan6['freq_khawatir_kokain'] == '6' ? 'checked' : '' }}>
                                        <label class="form-check-label">Pernah, dalam 3 bulan terakhir</label>
                                    </div>
                        
                                    <div class="form-check ml-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan6[freq_khawatir_kokain]" value="0"
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="d-flex">
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan6[freq_khawatir_stimulan]" value="3"
                                            {{ isset($napza->pertanyaan6['freq_khawatir_stimulan']) && $napza->pertanyaan6['freq_khawatir_stimulan'] == '3' ? 'checked' : '' }}>
                                        <label class="form-check-label">Pernah, tapi tidak dalam 3 bulan terakhir</label>
                                    </div>
                        
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan6[freq_khawatir_stimulan]" value="6"
                                            {{ isset($napza->pertanyaan6['freq_khawatir_stimulan']) && $napza->pertanyaan6['freq_khawatir_stimulan'] == '6' ? 'checked' : '' }}>
                                        <label class="form-check-label">Pernah, dalam 3 bulan terakhir</label>
                                    </div>
                        
                                    <div class="form-check ml-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan6[freq_khawatir_stimulan]" value="0"
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="d-flex">
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan6[freq_khawatir_inhalansia]" value="3"
                                            {{ isset($napza->pertanyaan6['freq_khawatir_inhalansia']) && $napza->pertanyaan6['freq_khawatir_inhalansia'] == '3' ? 'checked' : '' }}>
                                        <label class="form-check-label">Pernah, tapi tidak dalam 3 bulan terakhir</label>
                                    </div>
                        
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan6[freq_khawatir_inhalansia]" value="6"
                                            {{ isset($napza->pertanyaan6['freq_khawatir_inhalansia']) && $napza->pertanyaan6['freq_khawatir_inhalansia'] == '6' ? 'checked' : '' }}>
                                        <label class="form-check-label">Pernah, dalam 3 bulan terakhir</label>
                                    </div>
                        
                                    <div class="form-check ml-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan6[freq_khawatir_inhalansia]" value="0"
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="d-flex">
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan6[freq_khawatir_sedativa]" value="3"
                                            {{ isset($napza->pertanyaan6['freq_khawatir_sedativa']) && $napza->pertanyaan6['freq_khawatir_sedativa'] == '3' ? 'checked' : '' }}>
                                        <label class="form-check-label">Pernah, tapi tidak dalam 3 bulan terakhir</label>
                                    </div>
                        
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan6[freq_khawatir_sedativa]" value="6"
                                            {{ isset($napza->pertanyaan6['freq_khawatir_sedativa']) && $napza->pertanyaan6['freq_khawatir_sedativa'] == '6' ? 'checked' : '' }}>
                                        <label class="form-check-label">Pernah, dalam 3 bulan terakhir</label>
                                    </div>
                        
                                    <div class="form-check ml-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan6[freq_khawatir_sedativa]" value="0"
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="d-flex">
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan6[freq_khawatir_halusinogen]" value="3"
                                            {{ isset($napza->pertanyaan6['freq_khawatir_halusinogen']) && $napza->pertanyaan6['freq_khawatir_halusinogen'] == '3' ? 'checked' : '' }}>
                                        <label class="form-check-label">Pernah, tapi tidak dalam 3 bulan terakhir</label>
                                    </div>
                        
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan6[freq_khawatir_halusinogen]" value="6"
                                            {{ isset($napza->pertanyaan6['freq_khawatir_halusinogen']) && $napza->pertanyaan6['freq_khawatir_halusinogen'] == '6' ? 'checked' : '' }}>
                                        <label class="form-check-label">Pernah, dalam 3 bulan terakhir</label>
                                    </div>
                        
                                    <div class="form-check ml-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan6[freq_khawatir_halusinogen]" value="0"
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="d-flex">
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan6[freq_khawatir_opioid]" value="3"
                                            {{ isset($napza->pertanyaan6['freq_khawatir_opioid']) && $napza->pertanyaan6['freq_khawatir_opioid'] == '3' ? 'checked' : '' }}>
                                        <label class="form-check-label">Pernah, tapi tidak dalam 3 bulan terakhir</label>
                                    </div>
                        
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan6[freq_khawatir_opioid]" value="6"
                                            {{ isset($napza->pertanyaan6['freq_khawatir_opioid']) && $napza->pertanyaan6['freq_khawatir_opioid'] == '6' ? 'checked' : '' }}>
                                        <label class="form-check-label">Pernah, dalam 3 bulan terakhir</label>
                                    </div>
                        
                                    <div class="form-check ml-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan6[freq_khawatir_opioid]" value="0"
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <div class="d-flex align-items-center">
                                    <label>j. Zat-lain: sebutkan</label>
                                    <input type="text" class="form-control ml-2" name="pertanyaan6[freq_khawatir_zat_lain]"
                                        style="width: auto;" value="{{ isset($napza->pertanyaan6['freq_khawatir_zat_lain']) ? $napza->pertanyaan6['freq_khawatir_zat_lain'] : '' }}">
                                </div>
                                <div class="d-flex mt-2">
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan6[freq_khawatir_zat_lain_freq]" value="3"
                                            {{ isset($napza->pertanyaan6['freq_khawatir_zat_lain_freq']) && $napza->pertanyaan6['freq_khawatir_zat_lain_freq'] == '3' ? 'checked' : '' }}>
                                        <label class="form-check-label">Pernah, tapi tidak dalam 3 bulan terakhir</label>
                                    </div>
                        
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan6[freq_khawatir_zat_lain_freq]" value="6"
                                            {{ isset($napza->pertanyaan6['freq_khawatir_zat_lain_freq']) && $napza->pertanyaan6['freq_khawatir_zat_lain_freq'] == '6' ? 'checked' : '' }}>
                                        <label class="form-check-label">Pernah, dalam 3 bulan terakhir</label>
                                    </div>
                        
                                    <div class="form-check ml-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan6[freq_khawatir_zat_lain_freq]" value="0"
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="d-flex">
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan7[freq_kurang_tembakau]" value="3"
                                            {{ isset($napza->pertanyaan7['freq_kurang_tembakau']) && $napza->pertanyaan7['freq_kurang_tembakau'] == '3' ? 'checked' : '' }}>
                                        <label class="form-check-label">Pernah, tapi tidak dalam 3 bulan terakhir</label>
                                    </div>
                        
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan7[freq_kurang_tembakau]" value="6"
                                            {{ isset($napza->pertanyaan7['freq_kurang_tembakau']) && $napza->pertanyaan7['freq_kurang_tembakau'] == '6' ? 'checked' : '' }}>
                                        <label class="form-check-label">Pernah, dalam 3 bulan terakhir</label>
                                    </div>
                        
                                    <div class="form-check ml-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan7[freq_kurang_tembakau]" value="0"
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="d-flex">
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan7[freq_kurang_alkohol]" value="3"
                                            {{ isset($napza->pertanyaan7['freq_kurang_alkohol']) && $napza->pertanyaan7['freq_kurang_alkohol'] == '3' ? 'checked' : '' }}>
                                        <label class="form-check-label">Pernah, tapi tidak dalam 3 bulan terakhir</label>
                                    </div>
                        
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan7[freq_kurang_alkohol]" value="6"
                                            {{ isset($napza->pertanyaan7['freq_kurang_alkohol']) && $napza->pertanyaan7['freq_kurang_alkohol'] == '6' ? 'checked' : '' }}>
                                        <label class="form-check-label">Pernah, dalam 3 bulan terakhir</label>
                                    </div>
                        
                                    <div class="form-check ml-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan7[freq_kurang_alkohol]" value="0"
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="d-flex">
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan7[freq_kurang_kanabis]" value="3"
                                            {{ isset($napza->pertanyaan7['freq_kurang_kanabis']) && $napza->pertanyaan7['freq_kurang_kanabis'] == '3' ? 'checked' : '' }}>
                                        <label class="form-check-label">Pernah, tapi tidak dalam 3 bulan terakhir</label>
                                    </div>
                        
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan7[freq_kurang_kanabis]" value="6"
                                            {{ isset($napza->pertanyaan7['freq_kurang_kanabis']) && $napza->pertanyaan7['freq_kurang_kanabis'] == '6' ? 'checked' : '' }}>
                                        <label class="form-check-label">Pernah, dalam 3 bulan terakhir</label>
                                    </div>
                        
                                    <div class="form-check ml-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan7[freq_kurang_kanabis]" value="0"
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="d-flex">
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan7[freq_kurang_kokain]" value="3"
                                            {{ isset($napza->pertanyaan7['freq_kurang_kokain']) && $napza->pertanyaan7['freq_kurang_kokain'] == '3' ? 'checked' : '' }}>
                                        <label class="form-check-label">Pernah, tapi tidak dalam 3 bulan terakhir</label>
                                    </div>
                        
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan7[freq_kurang_kokain]" value="6"
                                            {{ isset($napza->pertanyaan7['freq_kurang_kokain']) && $napza->pertanyaan7['freq_kurang_kokain'] == '6' ? 'checked' : '' }}>
                                        <label class="form-check-label">Pernah, dalam 3 bulan terakhir</label>
                                    </div>
                        
                                    <div class="form-check ml-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan7[freq_kurang_kokain]" value="0"
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="d-flex">
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan7[freq_kurang_stimulan_amfetamin]" value="3"
                                            {{ isset($napza->pertanyaan7['freq_kurang_stimulan_amfetamin']) && $napza->pertanyaan7['freq_kurang_stimulan_amfetamin'] == '3' ? 'checked' : '' }}>
                                        <label class="form-check-label">Pernah, tapi tidak dalam 3 bulan terakhir</label>
                                    </div>
                        
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan7[freq_kurang_stimulan_amfetamin]" value="6"
                                            {{ isset($napza->pertanyaan7['freq_kurang_stimulan_amfetamin']) && $napza->pertanyaan7['freq_kurang_stimulan_amfetamin'] == '6' ? 'checked' : '' }}>
                                        <label class="form-check-label">Pernah, dalam 3 bulan terakhir</label>
                                    </div>
                        
                                    <div class="form-check ml-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan7[freq_kurang_stimulan_amfetamin]" value="0"
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="d-flex">
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan7[freq_kurang_inhalansia]" value="3"
                                            {{ isset($napza->pertanyaan7['freq_kurang_inhalansia']) && $napza->pertanyaan7['freq_kurang_inhalansia'] == '3' ? 'checked' : '' }}>
                                        <label class="form-check-label">Pernah, tapi tidak dalam 3 bulan terakhir</label>
                                    </div>
                        
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan7[freq_kurang_inhalansia]" value="6"
                                            {{ isset($napza->pertanyaan7['freq_kurang_inhalansia']) && $napza->pertanyaan7['freq_kurang_inhalansia'] == '6' ? 'checked' : '' }}>
                                        <label class="form-check-label">Pernah, dalam 3 bulan terakhir</label>
                                    </div>
                        
                                    <div class="form-check ml-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan7[freq_kurang_inhalansia]" value="0"
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="d-flex">
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan7[freq_kurang_sedativa]" value="3"
                                            {{ isset($napza->pertanyaan7['freq_kurang_sedativa']) && $napza->pertanyaan7['freq_kurang_sedativa'] == '3' ? 'checked' : '' }}>
                                        <label class="form-check-label">Pernah, tapi tidak dalam 3 bulan terakhir</label>
                                    </div>
                        
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan7[freq_kurang_sedativa]" value="6"
                                            {{ isset($napza->pertanyaan7['freq_kurang_sedativa']) && $napza->pertanyaan7['freq_kurang_sedativa'] == '6' ? 'checked' : '' }}>
                                        <label class="form-check-label">Pernah, dalam 3 bulan terakhir</label>
                                    </div>
                        
                                    <div class="form-check ml-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan7[freq_kurang_sedativa]" value="0"
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="d-flex">
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan7[freq_kurang_halusinogen]" value="3"
                                            {{ isset($napza->pertanyaan7['freq_kurang_halusinogen']) && $napza->pertanyaan7['freq_kurang_halusinogen'] == '3' ? 'checked' : '' }}>
                                        <label class="form-check-label">Pernah, tapi tidak dalam 3 bulan terakhir</label>
                                    </div>
                        
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan7[freq_kurang_halusinogen]" value="6"
                                            {{ isset($napza->pertanyaan7['freq_kurang_halusinogen']) && $napza->pertanyaan7['freq_kurang_halusinogen'] == '6' ? 'checked' : '' }}>
                                        <label class="form-check-label">Pernah, dalam 3 bulan terakhir</label>
                                    </div>
                        
                                    <div class="form-check ml-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan7[freq_kurang_halusinogen]" value="0"
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="d-flex">
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan7[freq_kurang_opioid]" value="3"
                                            {{ isset($napza->pertanyaan7['freq_kurang_opioid']) && $napza->pertanyaan7['freq_kurang_opioid'] == '3' ? 'checked' : '' }}>
                                        <label class="form-check-label">Pernah, tapi tidak dalam 3 bulan terakhir</label>
                                    </div>
                        
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan7[freq_kurang_opioid]" value="6"
                                            {{ isset($napza->pertanyaan7['freq_kurang_opioid']) && $napza->pertanyaan7['freq_kurang_opioid'] == '6' ? 'checked' : '' }}>
                                        <label class="form-check-label">Pernah, dalam 3 bulan terakhir</label>
                                    </div>
                        
                                    <div class="form-check ml-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan7[freq_kurang_opioid]" value="0"
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <div class="d-flex align-items-center">
                                    <label>j. Zat-lain: sebutkan</label>
                                    <input type="text" class="form-control ml-2" name="pertanyaan7[freq_kurang_zat_lain]" 
                                        value="{{ $napza->pertanyaan7['freq_kurang_zat_lain'] ?? '' }}" style="width: auto;">
                                </div>
                                <div class="d-flex mt-2">
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan7[freq_kurang_zat_lain_freq]" value="3"
                                            {{ isset($napza->pertanyaan7['freq_kurang_zat_lain_freq']) && $napza->pertanyaan7['freq_kurang_zat_lain_freq'] == '3' ? 'checked' : '' }}>
                                        <label class="form-check-label">Pernah, tapi tidak dalam 3 bulan terakhir</label>
                                    </div>
                        
                                    <div class="form-check mr-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan7[freq_kurang_zat_lain_freq]" value="6"
                                            {{ isset($napza->pertanyaan7['freq_kurang_zat_lain_freq']) && $napza->pertanyaan7['freq_kurang_zat_lain_freq'] == '6' ? 'checked' : '' }}>
                                        <label class="form-check-label">Pernah, dalam 3 bulan terakhir</label>
                                    </div>
                        
                                    <div class="form-check ml-3">
                                        <input type="radio" class="form-check-input" name="pertanyaan7[freq_kurang_zat_lain_freq]" value="0"
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <label>Pernahkah Anda menggunakan zat dengan
                                    ...
                                    <div class="d-flex">
                                        <div class="form-check mr-3">
                                            <input type="radio" class="form-check-input" name="pertanyaan8[non_medis]" value="2"
                                        ...
                                        <div class="form-check mr-3">
                                            <input type="radio" class="form-check-input" name="pertanyaan8[non_medis]" value="3"
                                        ...
                                        <div class="form-check ml-3">
                                            <input type="radio" class="form-check-input" name="pertanyaan8[non_medis]" value="0"
        ...
        <div class="text-right mt-4">
            ...
            <a href="{{ route('napza.mtbs.admin') }}" type="button" class="btn btn-secondary mr-2" style="font-size: 20px">Kembali</a>
        @else
