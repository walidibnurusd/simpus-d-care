...
@section('breadcrumb-title')
    <h3>Tes Daya Dengar</h3>
@endsection

@section('breadcrumb-items')
    <li class="breadcrumb-item">Admin</li>
    <li class="breadcrumb-item active">Tes Daya Dengar</li>
@endsection
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="display" id="basic-1">
                                ...
                                <tbody>
                                    @foreach ($testPendengaran as $item)
                                        <tr>
                                            ...
                                            <td>
                                                <ul class="action">
                                                    <li class="edit"> <a href="{{ route('testPendengaran.mtbs.edit', $item->id) }}"><i
                                                    ...
                                                    <li class="delete">
                                                        ...
                                                        <form action="{{ route('testPendengaran.mtbs.delete', $item->id) }}"
