...
@section('title', 'Keswa SDQ Remaja')
...
@section('breadcrumb-title')
    <h3>Keswa SDQ Remaja</h3>
@endsection

@section('breadcrumb-items')
    <li class="breadcrumb-item">Admin</li>
    <li class="breadcrumb-item active">Keswa SDQ Remaja</li>
@endsection
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="display" id="basic-1">
                                ...
                                <tbody>
                                    @foreach ($gangguanJiwaRemaja as $item)
                                        <tr>
                                            ...
                                            <td>
                                                <ul class="action">
                                                    <li class="edit"> <a href="{{ route('sdq.remaja.mtbs.edit', $item->id) }}"><i
                                                    ...
                                                    <li class="delete">
                                                        ...
                                                        <form action="{{ route('sdq.remaja.mtbs.delete', $item->id) }}"
