...
@section('breadcrumb-items')
    ...
    <li class="breadcrumb-item active">Merokok</li>
@endsection
                                ...
                                <tbody>
                                    @foreach ($merokok as $item)
                                        <tr>
                                            ...
                                            <td>
                                                <ul class="action">
                                                    <li class="edit"> <a href="{{ route('merokok.mtbs.edit', $item->id) }}"><i
                                                    ...
                                                    <li class="delete">
                                                        ...
                                                        <form action="{{ route('merokok.mtbs.delete', $item->id) }}"
