...
@section('breadcrumb-items')
    ...
    <li class="breadcrumb-item active">Keswa SDQ</li>
@endsection
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="display" id="basic-1">
                                ...
                                <tbody>
                                    @foreach ($gangguanJiwaAnak as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <ul class="action">
                                                <li class="edit"> <a href="{{ route('sdq.mtbs.edit', $item->id) }}"><i class="icon-pencil-alt"></i></a>
                                                </li>
                                                <li class="delete">
                                                    ...
                                                    <form action="{{ route('sdq.mtbs.delete', $item->id) }}" method="POST" id="delete-form-{{ $item->id }}" style="display:none;">
                                                        @csrf
                                                        @method('DELETE')
                                                    </form>
                                                </li>
