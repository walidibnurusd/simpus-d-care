...
@section('content')
    ...
    <form action="{{ isset($puma) ? route('puma.lansia.update', $puma->id) : route('puma.lansia.store') }}"
        method="POST">
        @csrf
        @if (isset($puma))
            @method('PUT')
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <div id="smoking-questions" style="display: {{ old('merokok', $puma->merokok ?? '') == '1' ? 'block' : 'none' }};">
                            <br>
                            ...
                            <p class="form-check-label">Pack years = Lama merokok dalam tahun x Jumlah batang rokok per hari / 20</p>
                            ...
                            <div class="d-flex">
                                <div class="form-check mr-3">
                                    <input type="radio" class="form-check-input" name="rokok_per_tahun" value="0"
                                        onclick="calculateTotalScore()"
                                        {{ old('rokok_per_tahun', $puma->rokok_per_tahun ?? '') == '0' ? 'checked' : '' }}>
                                    <label class="form-check-label">< 20 bungkus tahun</label>
                                </div>
                                <div class="form-check">
                                    <input type="radio" class="form-check-input" name="rokok_per_tahun" value="1"
                                        onclick="calculateTotalScore()"
                                        {{ old('rokok_per_tahun', $puma->rokok_per_tahun ?? '') == '1' ? 'checked' : '' }}>
                                    <label class="form-check-label">20 - 30 bungkus tahun</label>
                                </div>
                                <div class="form-check ml-3">
                                    <input type="radio" class="form-check-input" name="rokok_per_tahun" value="2"
                                        onclick="calculateTotalScore()"
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        <label>2. Apakah Anda pernah merasa napas pendek ketika Anda berjalan lebih cepat pada jalan yang datar atau pada jalan yang sedikit menanjak?</label>
                        <div class="d-flex">
                            <div class="form-check mr-3">
                                <input type="radio" class="form-check-input" name="nafas_pendek" value="1" onclick="calculateTotalScore()"
                                    {{ old('nafas_pendek', $puma->nafas_pendek ?? '') == '1' ? 'checked' : '' }}>
                                <label class="form-check-label">Ya</label>
                            </div>
                
                            <div class="form-check ml-3">
                                <input type="radio" class="form-check-input" name="nafas_pendek" value="0" onclick="calculateTotalScore()"
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        <label>3. Apakah Anda biasanya mempunyai dahak yang berasal dari paru atau kesulitan mengeluarkan dahak saat Anda sedang tidak menderita flu?</label>
                        <div class="d-flex">
                            <div class="form-check mr-3">
                                <input type="radio" class="form-check-input" name="punya_dahak" value="1" onclick="calculateTotalScore()"
                                    {{ old('punya_dahak', $puma->punya_dahak ?? '') == '1' ? 'checked' : '' }}>
                                <label class="form-check-label">Ya</label>
                            </div>
                
                            <div class="form-check ml-3">
                                <input type="radio" class="form-check-input" name="punya_dahak" value="0" onclick="calculateTotalScore()"
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <div class="d-flex">
                            <div class="form-check mr-3">
                                <input type="radio" class="form-check-input" name="batuk" value="1" onclick="calculateTotalScore()"
                                    {{ old('batuk', $puma->batuk ?? '') == '1' ? 'checked' : '' }}>
                                <label class="form-check-label">Ya</label>
                            </div>
                
                            <div class="form-check ml-3">
                                <input type="radio" class="form-check-input" name="batuk" value="0" onclick="calculateTotalScore()"
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        <label>5. Apakah Dokter atau tenaga kesehatan lainnya pernah meminta Anda untuk melakukan pemeriksaan fungsi paru dengan alat spirometry atau peakflow meter (meniup ke dalam suatu alat)?</label>
                        <div class="d-flex">
                            <div class="form-check mr-3">
                                <input type="radio" class="form-check-input" name="periksa_paru" value="1" onclick="calculateTotalScore()"
                                    {{ old('periksa_paru', $puma->periksa_paru ?? '') == '1' ? 'checked' : '' }}>
                                <label class="form-check-label">Ya</label>
                            </div>
                
                            <div class="form-check ml-3">
                                <input type="radio" class="form-check-input" name="periksa_paru" value="0" onclick="calculateTotalScore()"
