...
@section('content')
    ...
    <form
            ...
            <div class="row">
                        ...
                        <div class="d-flex">
                            <div class="form-check mr-3">
                                <input type="radio" class="form-check-input" name="jenis_kelamin" value="laki-laki" id="laki-laki"
                                    {{ (old('jenis_kelamin') == 'laki-laki' || (isset($kankerParu) && $kankerParu->jenis_kelamin == 'laki-laki')) ? 'checked' : '' }}>
                                <label class="form-check-label" for="laki-laki">Laki-laki</label>
                            </div>
                            <div class="form-check">
                                <input type="radio" class="form-check-input" name="jenis_kelamin" value="perempuan" id="perempuan"
                                    {{ (old('jenis_kelamin') == 'perempuan' || (isset($kankerParu) && $kankerParu->jenis_kelamin == 'perempuan')) ? 'checked' : '' }}>
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <div class="d-flex">
                            ...
                            <div class="form-check ml-3">
                                <input type="radio" class="form-check-input" name="kanker" value="3"
                                    id="ya" {{ old('kanker', $kankerParu->kanker ?? '') == 3 ? 'checked' : '' }}>
                        ...
                        <div class="d-flex">
                            ...
                            <div class="form-check ml-3">
                                <input type="radio" class="form-check-input" name="merokok" value="3"
                                    id="ya" {{ old('merokok', $kankerParu->merokok ?? '') == 3 ? 'checked' : '' }}>
                                <label class="form-check-label" for="ya">Bekas perokok, berhenti < 15 tahun
                                        lalu</label>
                            </div>
                            <div class="form-check ml-3">
                                <input type="radio" class="form-check-input" name="merokok" value="4"
                                    id="ya" {{ old('merokok', $kankerParu->merokok ?? '') == 4 ? 'checked' : '' }}>
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <div class="d-flex">
                            <div class="form-check mr-3">
                                <input type="radio" class="form-check-input" name="riwayat_tempat_kerja"
                                    value="1" id="tidak"
        ...
        <div class="text-right mt-4">
            ...
            <a href="{{ route('kankerParu.lansia.admin') }}" type="button" class="btn btn-secondary mr-2" style="font-size: 20px">Kembali</a>
        @else
