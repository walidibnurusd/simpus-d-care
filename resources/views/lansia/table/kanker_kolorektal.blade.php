...
@section('title', 'Kanker Kolorektal')
...
@section('breadcrumb-title')
    <h3>Kanker Kolorektal</h3>
@endsection

@section('breadcrumb-items')
    <li class="breadcrumb-item">Admin</li>
    <li class="breadcrumb-item active">Kanker Kolorektal</li>
@endsection
                                        ...
                                        <td>
                                            <ul class="action">
                                                ...
                                                <li class="delete">
                                                    ...
                                                    <form action="{{ route('kankerKolorektal.lansia.delete', $item->id) }}" method="POST" id="delete-form-{{ $item->id }}" style="display:none;">
                                                        @csrf
                                                        @method('DELETE')
                                                    </form>
                                                </li>
