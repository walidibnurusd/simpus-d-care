...
@section('breadcrumb-items')
    ...
    <li class="breadcrumb-item active">Puma</li>
@endsection
                            ...
                            <table class="display" id="basic-1">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <ul class="action">
                                                <li class="edit"> <a href="{{ route('puma.lansia.edit', $item->id) }}"><i class="icon-pencil-alt"></i></a>
                                                </li>
                                                <li class="delete">
                                                    ...
                                                    <form action="{{ route('puma.lansia.delete', $item->id) }}" method="POST" id="delete-form-{{ $item->id }}" style="display:none;">
                                                        @csrf
                                                        @method('DELETE')
                                                    </form>
                                                </li>
