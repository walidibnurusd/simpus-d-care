    ...
    public function updatePuma(Request $request, $id)
{
    ...
    return redirect()->route('puma.lansia.admin')
        ->with('success', 'Data Puma berhasil diperbarui!');
}

public function viewKankerParu()
{
    $kankerParu =  KankerParu::all();
...
public function editKankerParu($id)
{
    ...
    return view('lansia.kanker_paru', compact('kankerParu'));
}
...
public function updateKankerParu(Request $request, $id)
{
    ...
    return redirect()->route('kankerParu.lansia.admin')
        ->with('success', 'Data Kanker Paru has been successfully updated!');
}
...
public function updateKankerKolorektal(Request $request, $id)
{
    ...
    $kankerKolorektal->update(array_merge(
        $validator->validated(), // Data hasil validasi
        [
    ...
    // Redirect dengan pesan sukses
    return redirect()->route('kankerKolorektal.lansia.admin')
        ->with('success', 'Data Kanker Kolorektal berhasil diperbarui!');
}
...
public function updateKankerPayudara(Request $request, $id)
{
    ...
    $kankerPayudara->update(array_merge(
        $validatedData,
        [
...
public function updateGeriatri(Request $request, $id)
{
    ...
    try {
        ...
        // Redirect dengan pesan sukses
        return redirect()->route('geriatri.lansia.admin') // Sesuaikan rute Anda
            ->with('success', 'Data Geriatri berhasil diperbarui!');
    } catch (\Illuminate\Database\Eloquent\ModelNotFoundException $e) {
        // Jika data tidak ditemukan
        return redirect()->back()
            ->with('error', 'Data Geriatri tidak ditemukan.');
    } catch (\Exception $e) {
